...
if(isset($_POST['update_payment'])){
   ...
   $message[] = 'Mise à jour de l\'état du paiement!';
...
<section class="placed-orders">
   ...
   ?>
   <div class="box">
      <p> utilisateur id : <span><?= $fetch_orders['user_id']; ?></span> </p>
      ...
      <p> total produit : <span><?= $fetch_orders['total_products']; ?></span> </p>
      <p> total prix : <span><?= $fetch_orders['total_price']; ?>€/-</span> </p>
   ...
   <?php
      ...
      echo '<p class="empty">Aucune commande pour l\'instant!</p>';
   }
   ?>
