...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="nom du produit" name="name" maxlength="100" class="box">
      <input type="number" min="0" max="9999999999" required placeholder="prix unitaire produit" name="price" onkeypress="if(this.value.length == 10) return false;" class="box">
...
<section class="show-products" style="padding-top: 0;">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">MAJ</a>
